...
図\ref{fig:fcfs}より、各プロセスのターンアラウンドタイム及び平均ターンアラウンドタイムは、
...
平均ターンアラウンドタイムは $\text{[a]} = 140$ ミリ秒である。
...
図\ref{fig:rr}より、各プロセスのターンアラウンドタイム及び平均ターンアラウンドタイムは、
...
平均ターンアラウンドタイムは $\text{[b]} = 190$ ミリ秒である。
